...
import rsl_rl
from rsl_rl.algorithms import PPO, Distillation, PPO_Adapter
...
class OnPolicyRunner:
    ...
    def __init__(
        ...
        if (
            self.alg_cfg["class_name"] == "PPO"
            or self.alg_cfg["class_name"] == "PPO_Adapter"
        ):
        ...
        self.alg: PPO | Distillation | PPO_Adapter = alg_class(
