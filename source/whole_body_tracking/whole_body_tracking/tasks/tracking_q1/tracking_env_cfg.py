...
import whole_body_tracking.tasks.tracking_q1.mdp as mdp
...
class EventCfg:
    ...
    base_com = EventTerm(
        ...
        params={
            ...
            "com_range": {"x": (-0.025, 0.025), "y": (-0.05, 0.05), "z": (0.01, 0.05)},
        },
    )
    ...
    undesired_contacts = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_forces",
                body_names=[
                    r"^(?!L_ankle_roll_link$)(?!R_ankle_roll_link$)(?!L_wrist_yaw_link$)(?!R_wrist_yaw_link$).+$"
                ],
            ),
            "threshold": 1.0,
        },
