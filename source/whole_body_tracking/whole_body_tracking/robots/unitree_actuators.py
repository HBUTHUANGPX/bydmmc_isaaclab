...
@configclass
class EncosActuatorCfg_EC_A8112(UnitreeActuatorCfg):
...
@configclass
class EncosActuatorCfg_EC_A6408(UnitreeActuatorCfg):
...
@configclass
class EncosActuatorCfg_EC_A10020(UnitreeActuatorCfg):
...
@configclass
class EncosActuatorCfg_EC_A4310(UnitreeActuatorCfg):
    X1 = 7.853981634 # 额定转速
    X2 = 9.320058206 # 峰值转速
    Y1 = 12.0 # 额定扭矩
    Y2 = 36.0 # 峰值扭矩
...
@configclass
class Ti5ActuatorCfg_CRA_RI60_80(UnitreeActuatorCfg):
    X1 = 7.120943348 # 额定转速
    X2 = 8.58701992 # 峰值转速
    Y1 = 19.8 # 额定扭矩
    Y2 = 42.0 # 峰值扭矩
...
@configclass
class Ti5ActuatorCfg_CRA_RI50_70(UnitreeActuatorCfg):
    X1 = 7.853981634 # 额定转速
...
@configclass
class Ti5ActuatorCfg_CRA_RI40_52(UnitreeActuatorCfg):
    X1 = 8.37758041 # 额定转速
...
@configclass
class Ti5ActuatorCfg_CRA_RI30_40(UnitreeActuatorCfg):
    X1 = 9.424777961 # 额定转速
    X2 = 12.356931104 # 峰值转速
    Y1 = 1.8 # 额定扭矩
    Y2 = 3.3 # 峰值扭矩
...
@configclass
class HTActuatorCfg_DMS_6015(UnitreeActuatorCfg):
...
@configclass
class HTActuatorCfg_DMS_6015_2(UnitreeActuatorCfg):
